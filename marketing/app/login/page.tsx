...
export const metadata = {
  title: "Sign In — Ledgerforge",
  description: "Sign in to your Ledgerforge account and access the blockchain dashboard.",
};
        ...
        <div className="w-full max-w-md space-y-6">
          <div className="text-center">
            ...
            <p className="mt-3 text-sm text-paper-muted">
              Sign in to your Ledgerforge account.
            </p>
          </div>
          ...
          <p className="text-center text-sm text-paper-muted">
            ...
            <Link href="/signup" className="text-signal hover:text-signal/80 transition-colors font-medium">
              Sign up
            </Link>
          </p>
        </div>
